jQuery(function(){var defaultOptions={frameRate:150,animationTime:400,stepSize:100,pulseAlgorithm:1,pulseScale:4,pulseNormalize:1,accelerationDelta:50,accelerationMax:3,keyboardSupport:1,arrowScroll:50,fixedBackground:1,excluded:'',};var options=defaultOptions;var isExcluded=!1;var isFrame=!1;var direction={x:0,y:0};var initDone=!1;var root=document.documentElement;var activeElement;var observer;var refreshSize;var deltaBuffer=[];var deltaBufferTimer;var isMac=/^Mac/.test(navigator.platform);var key={left:37,up:38,right:39,down:40,spacebar:32,pageup:33,pagedown:34,end:35,home:36};var arrowKeys={37:1,38:1,39:1,40:1};var scrollOptions={frameRate:(jQuery('body').data('fr'))?jQuery('body').data('fr'):150,animationTime:(jQuery('body').data('at'))?jQuery('body').data('at'):1000,stepSize:(jQuery('body').data('stepSize'))?jQuery('body').data('stepSize'):100,pulseAlgorithm:1,pulseScale:4,pulseNormalize:1,accelerationDelta:(jQuery('body').data('ad'))?jQuery('body').data('ad'):50,accelerationMax:(jQuery('body').data('am'))?jQuery('body').data('am'):3,keyboardSupport:1,arrowScroll:50,fixedBackground:1};SmoothScroll(scrollOptions)
...
var uniqueID=(function(){var i=0;return function(el){return el.uniqueID||(el.uniqueID=i++)}})();var cacheX={};var cacheY={};var clearCacheTimer;var smoothBehaviorForElement={};setInterval(function(){if("undefined"!=typeof cache)
cache={}},10*1000);function scheduleClearCache(){clearTimeout(clearCacheTimer);clearCacheTimer=setInterval(function(){cacheX=cacheY=smoothBehaviorForElement={}},1*1000)}
...
return pulse_(x)}
var allowedBrowsers=["Mobile","IEWin7","Safari","Chrome","Firefox","Edge"];var userAgent=window.navigator.userAgent;var isEdge=/Edge/.test(userAgent);var isChrome=/chrome/i.test(userAgent)&&!isEdge;var isSafari=/safari/i.test(userAgent)&&!isEdge;var isFirefox=/firefox/i.test(userAgent);var isMobile=/mobile/i.test(userAgent);var isIEWin7=/Windows NT 6.1/i.test(userAgent)&&/rv:11/i.test(userAgent);var isOldSafari=isSafari&&(/Version\/8/i.test(userAgent)||/Version\/9/i.test(userAgent));var isEnabledForBrowser=isEnabledForBrowserCheck();function isEnabledForBrowserCheck(){if(isMobile)return~allowedBrowsers.indexOf('Mobile');if(isEdge)return~allowedBrowsers.indexOf('Edge');else if(isChrome)return~allowedBrowsers.indexOf('Chrome');else if(isSafari)return~allowedBrowsers.indexOf('Safari');else if(isFirefox)return~allowedBrowsers.indexOf('Firefox');else if(isIEWin7)return~allowedBrowsers.indexOf('IEWin7')}
